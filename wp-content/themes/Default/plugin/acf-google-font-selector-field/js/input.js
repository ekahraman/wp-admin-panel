                ...
                jQuery(document).on( 'change', '.acfgfs-font-family select', function(){
                    ...
                    jQuery.ajax({
                        ...
                        success: function( response ) {
							...
							font = new_font.replace( ' ', '+' );
							container.find('.acfgfs-preview').html('<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=' + font + '"><div style="font-family:' + font + '">Bu yazı seçili fontun önizlemesir</div>')
