...
function enqueue_fonts(){
    ...
    return $font_string.':'.$subset_string;
}
function google_fonts_css_async() {
    $new = enqueue_fonts();
    ?>
    <script type='text/javascript'>WebFontConfig={google:{families:["<?php echo $new; ?>"]},active:function(){sessionStorage.fonts=true;}},function(){var a=document.createElement("script");a.src="https://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",a.type="text/javascript",a.async="true";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}();</script>
    <?php
}
add_action( 'wp_footer', 'google_fonts_css_async' );
