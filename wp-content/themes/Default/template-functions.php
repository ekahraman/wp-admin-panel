...
function content_class($class = false, $style = false) {
    if($class) {
        ...
        if(get_options('ust_bosluk') || get_options('alt_bosluk')) {
            ...
            return '.content_class{'.$child.'}';
        }
    }
}
/*
function style_class_site() {
    $class = ''; $child = '';
...
function header_background() {
    $class = ''; $child = ''; $child2 = 'border-bottom:';
    if(get_options('header_background_image') || get_options('header_background_color') || get_options('header_top_padding') || get_options('header_bottom_padding') || get_options('header_border_style') || get_options('header_border_size') || get_options('header_border_color')) {
        ...
        if(get_options('header_border_on_off')) {
